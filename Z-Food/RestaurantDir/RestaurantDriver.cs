    ...
    public class RestaurantDriver
    {
        ...
        public void Start(Restaurant restaurant)
        {
            while (true)
            {
                ...
                {
                    case 1:
                        FoodService.GetInstance().Add((FoodDataBase)restaurant.Db);
                        break;
                    case 2:
                        FoodService.GetInstance().Remove((FoodDataBase)restaurant.Db);
                        break;
                    case 3:
                        FoodService.GetInstance().Update((FoodDataBase)restaurant.Db);
                        break;
                    case 4:
                        FoodService.GetInstance().View((FoodDataBase)restaurant.Db);
                        break;
                    case 5:
                        break;
                    case 6:
