...
namespace Z_Food
{
    public class FoodService
    {
        ...
        public bool Add(IFoodDB foodDb)
        {
            Console.WriteLine();
            string Name = SetName();
        ...
        public void Remove(IFoodDB foodDb)
        {
        ...
        public void View(IFoodDB foodDb)
        {
            if (foodDb.Size() == 0)
            {
        ...
        public void ViewFoodDetails(FoodItem food)
        {
            ...
            if (food.Availability == true)
                Console.WriteLine(PrintStatement.Available);
            else
                Console.WriteLine(PrintStatement.WillBeAvailableSoon);
        ...
        public void Update(IFoodDB foodDb)
        {
